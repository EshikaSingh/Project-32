...
function setup() {
  ...
  block1 = new Block(327,285,40,50);
  block2 = new Block(335,285,40,50);
  block3 = new Block(355,285,40,50);
  block4 = new Block(398,285,40,50);
  block5 = new Block(428,285,40,50);
  block6 = new Block(458,285,40,50);
  block7 = new Block(488,285,40,50);

  block8 = new Block(335,110,40,50);
  block9 = new Block(368,110,40,50);
  block10 = new Block(398,110,40,50);
  block11 = new Block(430,110,40,50);
  block12 = new Block(460,110,40,50);

  block13 = new Block(367,50,40,50);
  block14 = new Block(397,50,40,50);
  block15 = new Block(430,50,40,50);
  
  block16 = new Block(397,10,40,50);
